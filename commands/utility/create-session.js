...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                .setName("description")
                .setDescription(
                    "Add a session description, perhaps a one-sentence recap, plus a session hook."
                )
                .setRequired(true)
        ),
    ...
    async execute(interaction) {
        ...
        logger.log(
            "🚀 ~ file: create-session.js:75 ~ execute ~ players:",
            players
        );
        ...
        const embedSessionAttendance = new EmbedBuilder()
            ...
            .setFooter({
                text: `RSVP by ${rsvpDeadlineDate.toLocaleString(
        ...
        const maybe = new ButtonBuilder()
            ...
            .setEmoji("❔");
        const buttonsAttendanceStatus = new ActionRowBuilder().addComponents(
            attending,
            notAttending,
            maybe
        );
