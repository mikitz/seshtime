...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.isButton()) {
            ...
            let event = JSON.parse(events).find(
            ...
            if (buttonId === "attending") {
                ...
                notAttending = removeMemberFromRSVPList(
                    notAttending,
                    memberNickname
                );
            ...
            try {
                ...
                logger.error(
                    `Error updating the message ${interaction.id} : ${error}`
                );
            }
